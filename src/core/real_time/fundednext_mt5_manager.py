"""
FUNDEDNEXT MT5 TERMINAL MANAGER
==============================
Gestor exclusivo para FundedNext MT5 Terminal con lógica inteligente de apertura

PUERTA: PUERTA-S2-FUNDEDNEXT
VERSIÓN: v1.0.0
FECHA: 2025-08-11
"""
...
class FundedNextMT5Manager:
    ...
    def __init__(self, 
        ...
        self.component_id = "PUERTA-S2-FUNDEDNEXT"
        self.version = "v1.0.0"
